    ...
    def __init__(self, cfg=None):
        ...
        for x in modules.modules():
            if type(x) == nn.Conv2d:
                ...
                if kernel_size == 1:
                    y = nn.Conv2d(in_size, out_size, kernel_size=kernel_size, padding=(0, 0))
                elif kernel_size == 3:
                    y = nn.Conv2d(in_size, out_size, kernel_size=kernel_size, padding=(1, 1))
                else:
                    y = nn.Conv2d(in_size, out_size, kernel_size=kernel_size, padding=(3, 3))
